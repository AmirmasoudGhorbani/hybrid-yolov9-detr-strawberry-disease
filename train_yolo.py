"""
train_yolo.py — Stage 1 of the pipeline.

Trains a YOLOv9s model from scratch on the strawberry dataset (YOLO format).
Produces the initial `best.pt` weights that `finetune_yolo.py` (stage 2) refines.
